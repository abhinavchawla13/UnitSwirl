...
public class AnimatedGifViewReverse extends View {
    ...
    public AnimatedGifViewReverse(Context context) {
        super(context);
        init(context);
    }

    public AnimatedGifViewReverse(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AnimatedGifViewReverse(Context context, AttributeSet attrs, int defStyleAttr) {
